...
shortdescription: <ul><li>University Coursework</li><li>C++ physics, AI, networking development project</li><li>4 week development</li></ul>
permalink: /CSC8503
priority: 2
---
<h2>Languages: C++ (Custom Engine). Grade: 98%.</h2>
<h1>About</h1>
...
<ul>
<li>Collision: Detection and resolution between rays, Axis-Aligned Bounding Boxes and spheres.</li>
<li>AI: State machines and finding algorithms.</li>
...
<br>
GitHub repo at: <a href="https://github.com/JunkyX1122/CSC8503-2023">https://github.com/JunkyX1122/CSC8503-2023</a>.<br>
...
<ul>
<li><a href="#Server-Client Network">Server-Client Network</a></li>
<li><a href="#Capsule Collision">Capsule Collision</a></li>
...
<ul>
<li>The current states of non-static objects.</li>
<li>Scoring information - specific client's score and the current highest scoring player's score.</li>
<li>In-game state information - timer.</li>
